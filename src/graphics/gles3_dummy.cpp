...
GLboolean glIsQuery (GLuint id) {return GL_FALSE;};
...
GLboolean glIsVertexArray (GLuint array) {return GL_FALSE;};
...
GLboolean glIsSync (GLsync sync) {return GL_FALSE;};
...
GLboolean glIsSampler (GLuint sampler) {return GL_FALSE;};
...
GLboolean glIsTransformFeedback (GLuint id) {return GL_FALSE;};
